...
class Petition(CTA):
    ...
    checkbox_1 = models.CharField(
        max_length=1024,
        help_text='(currently disabled) label for the first checkbox option (may contain HTML)',
        blank=True,
        editable=False,
    )
    ...
    checkbox_2 = models.CharField(
        max_length=1024,
        help_text='(currently disabled) label for the second checkbox option (may contain HTML)',
        blank=True,
        editable=False,
    )
